...
@SuppressWarnings("unused")public final class LoginSvrConfig extends Table {
  ...
  public static LoginSvrConfig getRootAsLoginSvrConfig(ByteBuffer _bb, LoginSvrConfig obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createLoginSvrConfig(FlatBufferBuilder builder,
      int hostOffset,
      int portOffset,
      int dbOffset) {
  ...
  public static int endLoginSvrConfig(FlatBufferBuilder builder) {
